                    ...
                    <div class="col-md-8">
                        ...
                        <form id="login_form">
                            ...
                            <div class="d-flex mb-1 align-items-center">
                                ...
                                <span class="ml-auto" style="margin-left: 5px;"><a href="#" data-bs-toggle="modal"
                                                                                   data-bs-target="#loginModal"
                                                                                   class="forgot-pass"> Şifre Hatırlat</a></span>
                            </div>

                            <div class="d-flex mb-4 align-items-center" id="feedBackLogin">
                            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-floating mb-1">
                    <input id="pass_email" type="email" aria-describedby="emailHelp" class="form-control" required
                           placeholder="E-Mail"/>
